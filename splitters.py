...
def scaffold_split(dataset, smiles_list, task_idx=None, null_value=0,
                   ...
                   return_smiles=False, regression=False):
    """
...
def random_scaffold_split(dataset, smiles_list, task_idx=None, null_value=0,
                          frac_train=0.8, frac_valid=0.1, frac_test=0.1, seed=0, regression=False):
    """
...
def random_split(dataset, task_idx=None, null_value=0,
                 frac_train=0.8, frac_valid=0.1, frac_test=0.1,
                 seed=0, smiles_list=None, regression=False):
    """
...
def cv_random_split(dataset, fold_idx=0,
    ...
    train_dataset = [dataset[n] for n in torch.tensor(train_idx)]
    valid_dataset = [dataset[n] for n in torch.tensor(val_idx)]
